      ...
      <div className="relative flex flex-col gap-4">
        <Card className="mx-auto h-140 w-full max-w-sm gap-0">
          <CardHeader className="gap-1 border-b">
            ...
            <CardDescription>今日はどのようなお手伝いができますか？</CardDescription>
            <CardAction>
              <TooltipTrigger>
                <Button
                  variant="outline"
            ...
            {messages.length === 0 ? (
              <Empty className="h-full">
                <EmptyHeader>
                  ...
                  <EmptyTitle>おはようございます、shadcn！</EmptyTitle>
                  <EmptyDescription>
                    今日は何に取り組みますか？送信を押して新しい会話を始めましょう
                  </EmptyDescription>
                </EmptyHeader>
              </Empty>
            ) : (
        ...
        <div className="px-0.5 text-center text-xs text-muted-foreground">
          これは閲覧専用のデモです。送信を押すとメッセージを送信できます。
        </div>
      </div>
    </MessageScrollerProvider>
  )
